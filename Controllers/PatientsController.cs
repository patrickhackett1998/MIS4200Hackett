...
namespace MIS4200Hackett.Controllers
{
    public class PatientsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "PatientID,description,PatientDate,DoctorID")] Patient patient)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "PatientID,description,PatientDate,DoctorID")] Patient patient)
        {
            if (ModelState.IsValid)
            {
